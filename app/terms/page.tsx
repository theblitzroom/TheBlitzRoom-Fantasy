...
const terms = [
  ["Service", "TheBlitzRoom Fantasy is a fantasy football software product that provides draft, roster, league, and trade analysis tools."],
  ...
  ["Third-party services", "Sleeper and Stripe integrations depend on third-party availability and terms. TheBlitzRoom Fantasy is not affiliated with Sleeper."],
...
export default function TermsPage() {
  return (
    <SectionShell
      ...
      title="Terms for using TheBlitzRoom Fantasy."
